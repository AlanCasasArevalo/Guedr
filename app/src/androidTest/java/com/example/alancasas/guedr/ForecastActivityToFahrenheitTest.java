...
import com.example.alancasas.guedr.activity.ForecastActivity;
...
public class ForecastActivityToFahrenheitTest {
    ...
    public void forecastActivityToFahrenheitTest() {
        ...
        ViewInteraction appCompatRadioButton2 = onView(
                allOf(withId(R.id.farenheit_rb), withText("Unidades Farenheit"),
                        childAtPosition(
                                allOf(withId(R.id.units_rg),
                                        childAtPosition(
                                                withClassName(is("android.support.constraint.ConstraintLayout")),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.max_temp), withText("Temp. maxima: 77.0 F"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Temp. maxima: 77.0 F")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.min_temp), withText("Temp. minima: 64.4 F"),
                        childAtPosition(
                                childAtPosition(
                                        IsInstanceOf.<View>instanceOf(android.widget.RelativeLayout.class),
                                        1),
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("Temp. minima: 64.4 F")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.min_temp), withText("Temp. minima: 64.4 F"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("Temp. minima: 64.4 F")));
